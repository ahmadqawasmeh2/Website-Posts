...
class postcontroller extends Controller
{
  public function __construct()
    ...
    'Post_Img'=>'image|nullable|max:1024',
        ...
        $save->save();
        return redirect('/post')->with('success','Done successfully');
    ...
    public function update(Request $req)
    {
        ...
        return redirect('/post')->with('success','update successfully');
    ...
    public function destroy($id)
    {
       ...
       $post->delete();
        ...
        return redirect('/post')->with('success','Delet successfully');
    }
